...
const handleSave = (id, newName, newDescription) => {
    if (id) {
      ...
      const updatedTones = tones.map(tone =>
        tone.id === id ? { ...tone, name: newName, description: newDescription } : tone
      );
